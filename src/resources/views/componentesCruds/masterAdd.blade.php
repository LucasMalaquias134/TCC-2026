...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>@yield('titulo' , "MasterPage")</title>
    ...
    <div class="app-wrapper">
        ...
        <nav class="app-header navbar navbar-expand" data-bs-theme="dark" style="background-color: #130D26 !important;">
            <div class="container-fluid" >
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('fichas.index')}}" role="button" >
                            <i class="bi bi-arrow-left text-white"></i>
                        </a>
                    </li>
                    <li class="nav-item d-none d-md-block" >
                        <a href="{{route('fichas.index')}}" class="nav-link text-white">@yield('Home','Home')</a>
                    </li>
                </ul>
            </div>
        </nav>
